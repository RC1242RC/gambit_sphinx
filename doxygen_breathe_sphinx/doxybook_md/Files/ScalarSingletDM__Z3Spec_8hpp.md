...
#ifndef __ScalarSingletDM_Z3SPEC_H__
...
namespace Gambit
{
   ...
   namespace SpecBit
   {
      ...
      template <class MI>
      const int ScalarSingletDM_Z3Spec<MI>::_index_offset = MI::index_offset;
      ...
      template <class MI>
      ScalarSingletDM_Z3Spec<MI>::ScalarSingletDM_Z3Spec(MI mi, str be_name, str be_version)
      ...
      template <class MI>
      ScalarSingletDM_Z3Spec<MI>::ScalarSingletDM_Z3Spec()
      {}
      ...
      template <class MI>
      void ScalarSingletDM_Z3Spec<MI>::RunToScaleOverride(double scale)
      {
        model_interface.model.run_to(scale);
      }
      template <class MI>
      double ScalarSingletDM_Z3Spec<MI>::GetScale() const
      {
        return model_interface.model.get_scale();
      }
      template <class MI>
      void ScalarSingletDM_Z3Spec<MI>::SetScale(double scale)
      {
        model_interface.model.set_scale(scale);
      }

      template <class MI>
      std::string ScalarSingletDM_Z3Spec<MI>::AccessError(std::string state) const
      {
        std::string errormsg;
      ...
      template <class MI>
      typename ScalarSingletDM_Z3Spec<MI>::GetterMaps ScalarSingletDM_Z3Spec<MI>::fill_getter_maps()
      {
         typename ScalarSingletDM_Z3Spec<MI>::GetterMaps map_collection;
      ...
      template <class MI>
      typename ScalarSingletDM_Z3Spec<MI>::SetterMaps ScalarSingletDM_Z3Spec<MI>::fill_setter_maps()
      {
         typename ScalarSingletDM_Z3Spec<MI>::SetterMaps map_collection;
         typedef typename MI::Model Model;
