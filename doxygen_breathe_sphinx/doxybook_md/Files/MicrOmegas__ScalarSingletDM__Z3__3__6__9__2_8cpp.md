...
BE_INI_FUNCTION
{
     ...
     *VWdecay = VWdecayOpt;
     ...
     logger() << LogTags::debug << "Initializing MicrOmegas ScalarSingletDM_Z3 with ";
...
//     double v = he.get(Par::mass1,"vev");
     ...
     error = assignVal((char*)"mu3", mu3);
     if (error != 0) backend_error().raise(LOCAL_INFO, "Unable to set mu3 in"
             "MicrOmegas. MicrOmegas error code: " + std::to_string(error));
