...
.. _file_ColliderBit_scripts_generate_raster_scan_settings.py:

File generate_raster_scan_settings.py
=====================================

|exhale_lsh| :ref:`Parent directory <dir_ColliderBit_scripts>` (``ColliderBit/scripts``)
...
Definition (``ColliderBit/scripts/generate_raster_scan_settings.py``)
---------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_ColliderBit_scripts_generate_raster_scan_settings.py.rst
...
- :ref:`namespace_generate_raster_scan_settings`
