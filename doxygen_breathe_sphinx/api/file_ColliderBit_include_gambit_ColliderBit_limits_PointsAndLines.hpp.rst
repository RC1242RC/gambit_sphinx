...
.. _file_ColliderBit_include_gambit_ColliderBit_limits_PointsAndLines.hpp:

File PointsAndLines.hpp
=======================

|exhale_lsh| :ref:`Parent directory <dir_ColliderBit_include_gambit_ColliderBit_limits>` (``ColliderBit/include/gambit/ColliderBit/limits``)
...
Definition (``ColliderBit/include/gambit/ColliderBit/limits/PointsAndLines.hpp``)
---------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_ColliderBit_include_gambit_ColliderBit_limits_PointsAndLines.hpp.rst
...
- ``limits`` (:ref:`file_ColliderBit_src_limits_ALEPHSleptonLimits.cpp`)
