...
|                | Name           |
| -------------- | -------------- |
| void | **[do_cleanup](/documentation/code/files/gambit_8cpp/#function-do-cleanup)**()<br>Cleanup function.  |
| int | **[main](/documentation/code/files/gambit_8cpp/#function-main)**(int argc, char * argv[])<br>Main GAMBIT program.  |
