...
#define Pythia_8_212_all_data \
  ...
  (( /*class*/(Pythia8)(Pythia),    /*constructors*/(("Factory_Pythia_0__BOSS_2",(std::basic_string<char>, bool))) (("Factory_Pythia_1__BOSS_3",(std::basic_string<char>))) (("Factory_Pythia_2__BOSS_4",())) (("Factory_Pythia_3__BOSS_5",(my_ns::Pythia8::ParticleData&, my_ns::Pythia8::Settings&, bool))) (("Factory_Pythia_4__BOSS_6",(my_ns::Pythia8::ParticleData&, my_ns::Pythia8::Settings&))) )) \
  ...
  (( /*class*/(Pythia8)(LHdecayChannel),    /*constructors*/(("Factory_LHdecayChannel_0__BOSS_15",())) (("Factory_LHdecayChannel_1__BOSS_16",(double, int, std::vector<int>, std::basic_string<char>))) (("Factory_LHdecayChannel_2__BOSS_17",(double, int, std::vector<int>))) )) \
  ...
  (( /*class*/(Pythia8)(SusyLesHouches),    /*constructors*/(("Factory_SusyLesHouches_0__BOSS_21",(int))) (("Factory_SusyLesHouches_1__BOSS_22",())) (("Factory_SusyLesHouches_2__BOSS_23",(std::basic_string<char>, int))) (("Factory_SusyLesHouches_3__BOSS_24",(std::basic_string<char>))) )) \
  ...
  (( /*class*/(Pythia8)(ParticleDataEntry),    /*constructors*/(("Factory_ParticleDataEntry_0__BOSS_38",(int, std::basic_string<char>, int, int, int, double, double, double, double, double))) (("Factory_ParticleDataEntry_1__BOSS_39",(int, std::basic_string<char>, int, int, int, double, double, double, double))) (("Factory_ParticleDataEntry_2__BOSS_40",(int, std::basic_string<char>, int, int, int, double, double, double))) (("Factory_ParticleDataEntry_3__BOSS_41",(int, std::basic_string<char>, int, int, int, double, double))) (("Factory_ParticleDataEntry_4__BOSS_42",(int, std::basic_string<char>, int, int, int, double))) (("Factory_ParticleDataEntry_5__BOSS_43",(int, std::basic_string<char>, int, int, int))) (("Factory_ParticleDataEntry_6__BOSS_44",(int, std::basic_string<char>, int, int))) (("Factory_ParticleDataEntry_7__BOSS_45",(int, std::basic_string<char>, int))) (("Factory_ParticleDataEntry_8__BOSS_46",(int, std::basic_string<char>))) (("Factory_ParticleDataEntry_9__BOSS_47",(int))) (("Factory_ParticleDataEntry_10__BOSS_48",())) (("Factory_ParticleDataEntry_11__BOSS_49",(int, std::basic_string<char>, std::basic_string<char>, int, int, int, double, double, double, double, double))) (("Factory_ParticleDataEntry_12__BOSS_50",(int, std::basic_string<char>, std::basic_string<char>, int, int, int, double, double, double, double))) (("Factory_ParticleDataEntry_13__BOSS_51",(int, std::basic_string<char>, std::basic_string<char>, int, int, int, double, double, double))) (("Factory_ParticleDataEntry_14__BOSS_52",(int, std::basic_string<char>, std::basic_string<char>, int, int, int, double, double))) (("Factory_ParticleDataEntry_15__BOSS_53",(int, std::basic_string<char>, std::basic_string<char>, int, int, int, double))) (("Factory_ParticleDataEntry_16__BOSS_54",(int, std::basic_string<char>, std::basic_string<char>, int, int, int))) (("Factory_ParticleDataEntry_17__BOSS_55",(int, std::basic_string<char>, std::basic_string<char>, int, int))) (("Factory_ParticleDataEntry_18__BOSS_56",(int, std::basic_string<char>, std::basic_string<char>, int))) (("Factory_ParticleDataEntry_19__BOSS_57",(int, std::basic_string<char>, std::basic_string<char>))) )) \
  ...
  (( /*class*/(Pythia8)(Parm),    /*constructors*/(("Factory_Parm_0__BOSS_92",(std::basic_string<char>, double, bool, bool, double, double))) (("Factory_Parm_1__BOSS_93",(std::basic_string<char>, double, bool, bool, double))) (("Factory_Parm_2__BOSS_94",(std::basic_string<char>, double, bool, bool))) (("Factory_Parm_3__BOSS_95",(std::basic_string<char>, double, bool))) (("Factory_Parm_4__BOSS_96",(std::basic_string<char>, double))) (("Factory_Parm_5__BOSS_97",(std::basic_string<char>))) (("Factory_Parm_6__BOSS_98",())) )) \
  ...
  (( /*class*/(Pythia8)(Hist),    /*constructors*/(("Factory_Hist_0__BOSS_108",())) (("Factory_Hist_1__BOSS_109",(std::basic_string<char>, int, double, double))) (("Factory_Hist_2__BOSS_110",(std::basic_string<char>, int, double))) (("Factory_Hist_3__BOSS_111",(std::basic_string<char>, int))) (("Factory_Hist_4__BOSS_112",(std::basic_string<char>))) (("Factory_Hist_5__BOSS_113",(std::basic_string<char>, const my_ns::Pythia8::Hist&))) )) \
