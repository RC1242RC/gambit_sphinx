---
title: 'file frontends/MicrOmegas_MajoranaSingletDM_Z2_3_6_9_2.cpp'
...
Frontend for MicrOmegas MajoranaSingletDM_Z2 3.6.9.2 backend
...
#include "gambit/Backends/frontends/MicrOmegas_MajoranaSingletDM_Z2_3_6_9_2.hpp"
#include <unistd.h>
...
BE_INI_FUNCTION
{
     ...
     *VWdecay = VWdecayOpt;
     ...
     logger() << LogTags::debug << "Initializing MicrOmegas MajoranaSingletDM_Z2 with ";
     ...
     *ForceUG=1;
     ...
     error = assignVal((char*)"lX", lX);
     if (error != 0) backend_error().raise(LOCAL_INFO, "Unable to set lX in"
             "MicrOmegas. MicrOmegas error code: " + std::to_string(error));
