---
title: 'file frontends/DarkSUSY_MSSM_6_2_5.cpp'
...
|                | Name           |
| -------------- | -------------- |
| | **[if](/documentation/code/files/darksusy__mssm__6__2__5_8cpp/#function-if)**(scan_level ) |
| | **[if](/documentation/code/files/darksusy__mssm__6__2__5_8cpp/#function-if)**(runOptions-> hasKey"debug_SLHA_filenames") |
| else | **[if](/documentation/code/files/darksusy__mssm__6__2__5_8cpp/#function-if)**(ModelInUse("CMSSM") and runOptions->getValueOrDef< bool >(false, "use_DS_isasugra") )<br>Option use_DS_isasugra<bool>: Use DS internal isasugra for parameter running (false)  |
| else | **[if](/documentation/code/files/darksusy__mssm__6__2__5_8cpp/#function-if)**(ModelInUse("MSSM63atQ")||ModelInUse("CMSSM") ) |
| | **[if](/documentation/code/files/darksusy__mssm__6__2__5_8cpp/#function-if)**((ModelInUse("MSSM63atQ")||ModelInUse("CMSSM")) &&! mssm_result) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| | **[BE_NAMESPACE](/documentation/code/files/darksusy__mssm__6__2__5_8cpp/#variable-be-namespace)**  |
| std::vector< double > | **[DSparticle_mass](/documentation/code/files/darksusy__mssm__6__2__5_8cpp/#variable-dsparticle-mass)**  |
...
#include "gambit/Backends/frontends/DarkSUSY_MSSM_6_2_5.hpp"
