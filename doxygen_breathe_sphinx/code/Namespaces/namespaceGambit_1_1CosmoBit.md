...
| void | **[class_get_lensed_Cl_BB](/documentation/code/namespaces/namespacegambit_1_1cosmobit/#function-class-get-lensed-cl-bb)**(std::vector< double > & result)<br>B-mode autocorrelation.  |
